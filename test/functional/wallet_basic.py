...
class WalletTest(GemmaTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 GEMMA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 GEMMA with subtract fee from amount
        ...
        # Sendmany 10 GEMMA with subtract fee from amount
