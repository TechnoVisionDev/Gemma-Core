...
class TxnMallTest(GemmaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 GEMMA:
        ...
        # First: use raw transaction API to send 1240 GEMMA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GEMMA coin each
